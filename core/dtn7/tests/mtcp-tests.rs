...
use dtn7::{cla::mtcp, core::helpers};
...
fn mpdu_encoding() {
    ...
    let expected_bytes = vec![
        88, 51, 159, 136, 7, 0, 0, 130, 1, 103, 47, 47, 100, 101, 115, 116, 47, 130, 1, 102, 47,
        47, 115, 114, 99, 47, 130, 1, 102, 47, 47, 115, 114, 99, 47, 130, 0, 0, 26, 0, 54, 238,
        128, 133, 1, 1, 0, 0, 67, 65, 65, 65, 255,
    ];
